...
; - ItemEffects (see engine/items/item_effects.asm)
	...
	const HEAT_ROCK    ; 87
	const DAMP_ROCK    ; 88
	const SMOOTH_ROCK  ; 89
	const CHARCOAL     ; 8a
	const BERRY_JUICE  ; 8b
	const SCOPE_LENS   ; 8c
	const NUTRI_ROOT   ; 8d
	const SPECIAL_DISH ; 8e
	const METAL_COAT   ; 8f
	const DRAGON_FANG  ; 90
	const GOLDEN_ACORN ; 91
	const LEFTOVERS    ; 92
	const OLD_AMBER    ; 93
...
;	add_mt TAKE_DOWN	;tm9 NOT ADDED TO TUTOR
	add_mt DOUBLE_EDGE	;tm10
	add_mt BUBBLEBEAM	;tm11
;	add_mt WATER_GUN	;tm12 NOT ADDED TO TUTOR
...
;	add_mt SKULL_BASH	;tm40 NOT ADDED TO TUTOR
...
;	add_mt PSYWAVE		;tm46 NOT ADDED TO TUTOR
