...
; Johto story events
	...
	const EVENT_SHADY_MOVE_TUTOR_HIDDEN
...
; trade sequence events
	...
	const EVENT_GOT_NUTRI_ROOT
	const EVENT_GOT_BERRYMIX
	const EVENT_GOT_HIDDEN_BUG_NET
	const EVENT_TALKED_TO_FLORIA_BERRYMIX
	const EVENT_TALKED_TO_FLORIA_GOLDEN_ACORN
	const EVENT_TALKED_TO_CHEF
