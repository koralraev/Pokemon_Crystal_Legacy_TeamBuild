...
ItemBeltSpriteGFX::	       INCBIN "gfx/sprites/item_belt.2bpp"
ItemSparkleSpriteGFX::	       INCBIN "gfx/sprites/sparkle.2bpp"
FlyServicePcSpriteGFX::	       INCBIN "gfx/sprites/flyservice_pc.2bpp"
FlyServiceAbraSpriteGFX::      INCBIN "gfx/sprites/flyservice_abra.2bpp"
; MunchlaxSpriteGFX::	       INCBIN "gfx/sprites/munchlax.2bpp"
