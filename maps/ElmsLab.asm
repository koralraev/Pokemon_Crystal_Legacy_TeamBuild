...
YesToSetNoToClearText:
	text "Yes to set event"
	line "No to clear event"
	done
...
ElmsLab_MapEvents:
	...
	def_object_events
	object_event 9, 7, SPRITE_ITEM_SPARKLE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, BookshelfToggleEvent, -1
	...
	object_event  9, 10, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, CustomNPCPokemonGiverScript, -1
